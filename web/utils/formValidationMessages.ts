export enum FormValidationMessage {
    incorrectCredentialsErrorText = 'The email address or password is incorrect',
    requiredValidationErrorText = 'Required',
    emailValidationErrorText = 'Must be valid email',
